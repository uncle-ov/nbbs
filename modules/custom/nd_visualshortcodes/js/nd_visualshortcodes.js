(function ($, Drupal, drupalSettings, once) {
  ...
  Drupal.behaviors.nd_visualshortcodes = {
	...
	// console.log(context);
      // $(once('default-hide', '.nd_visualshortcodes_links:not(.default-hide-processed)', context)).hide();
	  // console.log($('.nd_visualshortcodes_links').attr('class'));
 // return;
      // Load Visual Shortcodes layout
      $(once('nd-visual-shortcodes', '.nd_visualshortcodes_links:not(.nd-visual-shortcodes-processed)', context)).click(function() {
      ...
      // Shortcode Copy
      $(once('nd-visualshortcodes', '.nd-visualshortcodes-copy:not(.nd-visualshortcodes-processed)', context)).click(function() {
      ...
      $(once('nd-visualshortcodes', '.shortcode-settings:not(.nd-visualshortcodes-processed)', context)).click(function(event) {
...
// Add new shortcode form
      $(once('nd-visualshortcodes', '.nd-visualshortcodes-save:not(.nd-visualshortcodes-processed)', context)).click(function() {
        nd_visualshortcodes_save_form($(this));
      });


      // Add new shortcode form
      $(once('nd-visualshortcodes', '.nd_visualshortcodes_add:not(.nd-visualshortcodes-processed)', context)).click(function() {
        nd_visualshortcodes_add_form($(this));
      });

      $(once('nd-visualshortcodes', '.nd_visualshortcodes_enabled_links:not(.nd-visualshortcodes-processed) a', context)).click(function() {
      ...
      $(once('nd-visualshortcodes', '.nd_visualshortcodes_enabled_list_search input:not(.nd-visualshortcodes-processed)', context)).keyup(function() {
      ...
      $(once('nd-visual-shortcodes-format', '.filter-list:not(.nd-visual-shortcodes-format-processed)', context)).change(function() {
      ...
      if(drupalSettings.nd_visualshortcodes.autostart) {
        $(once('autostart', '.nd_visualshortcodes_links:not(.autostart-processed)', context)).click();
      ...
      $(once('color', '.colorpicker-enable:not(.color-processed)', context)).colorpicker();
